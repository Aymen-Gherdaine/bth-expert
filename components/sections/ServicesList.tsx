  ...
  useGSAP(
    () => {
      ...
      rows.forEach((row, i) => {
        ...
        // Right column trails the left slightly for a row-by-row cascade.
        gsap
          .timeline({
            delay: (i % 2) * 0.08,
  ...
  return (
    <section ref={sectionRef} className="bg-white relative z-10">
      <div className={`${PADX} pt-24 lg:pt-32 pb-14 lg:pb-20`}>
        {/* ── Header ─────────────────────────────────────────────── */}
        <span className="inline-flex items-center gap-3 font-sans uppercase tracking-[0.2em] text-gold text-[length:var(--text-caption)] mb-7">
        ...
        <p className="mt-6 max-w-xl font-sans text-muted leading-[1.7] text-[length:var(--text-body)]">
          {services.heading}
        </p>
            ...
            >
              ...
              <div data-row-content className="flex items-start gap-5 lg:gap-7">
                ...
                <div className="flex-1 min-w-0">
                  <h3
                    className="font-display font-light text-ink-soft tracking-[-0.02em] leading-[1.2] transition-colors duration-[var(--duration-base)] ease-[var(--ease-out-expo)] group-hover:text-ink"
                ...
                <span
                  aria-hidden
                  className="shrink-0 pt-1 font-sans text-lg text-muted transition-[transform,color] duration-[var(--duration-base)] ease-[var(--ease-out-expo)] group-hover:translate-x-1.5 group-hover:text-ink"
                >
                  →
                </span>
              </div>
